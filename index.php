...
<body >
	...
	<div id="header">
       <br>
       <h1 style=" font-family:Agency FB; font-size: 70px; color:f69314;text-shadow: 2px 2px black;"> Sparks Foundation Internship Project </h1>
    ...
    <footer color:"white" class="text-center mt-5 py-2">
      <p>&copy 2021. Made by <b>Ananya Kumari</b> <br> The Sparks Foundation</p>
    </footer>
